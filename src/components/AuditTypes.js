...
import { getAllTypes, fetchTypes, addCategory, isLoading, editCategory, deleteCategory } from '../features/auditType/auditTypeSlice';
...
const AuditTypes = () => {
    ...
    const categories = useSelector(getAllTypes)
        ...
        <div>
            <Container>
                ...
                <Modal show={show} onHide={handleClose}>
                    ...
                    <Modal.Title>Add Audit Type</Modal.Title>
                    </Modal.Header>
                    {lding ? <Container>
