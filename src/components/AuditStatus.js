...
const AuditStatus = () => {
    ...
    const handleEditSubmitCategory = (e, id) => {
        ...
        if (eName.length > 0) {
            setAlertShow(true)
            seterrmsg('Status already exists')
        }else {
        ...
        <div>
            <Container>
                ...
                <Modal show={show} onHide={handleClose}>
                    ...
                    <Modal.Title>Add Audit Status</Modal.Title>
                    </Modal.Header>
                    {lding ? <Container>
                    ...
                    <Form onSubmit={handleSubmitAddCategory}>
                        <Modal.Body>
                            <Form.Group className="mb-3" controlId="formBasicName">
                                <Form.Label><strong>Status Name: </strong></Form.Label>
                ...
                <Modal show={deleteShow} onHide={handleDeleteClose}>
                    ...
                    <Modal.Body>
                        <p className='text-danger'>Are you sure you want to delete this status?</p>
                    </Modal.Body>
                    <Modal.Footer>
