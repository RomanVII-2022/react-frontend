        ...
        <div>
            <Container>
                ...
                <Modal show={show} onHide={handleClose}>
                    ...
                    <Modal.Title>Add Audit Measure</Modal.Title>
                    </Modal.Header>
                    {lding ? <Container>
                    ...
                    <Form onSubmit={handleSubmitAddCategory}>
                        <Modal.Body>
                            <Form.Group className="mb-3" controlId="formBasicName">
                                <Form.Label><strong>Measure Name: </strong></Form.Label>
                ...
                <Modal show={editShow} onHide={handleEditClose}>
                    <Modal.Header closeButton>
                    <Modal.Title>Edit Measure</Modal.Title>
                    </Modal.Header>
                    {lding ? <Container>
                        <Row className="justify-content-md-center">
                            <Col md="auto">
                ...
                <Modal show={deleteShow} onHide={handleDeleteClose}>
                    ...
                    <Modal.Body>
                        <p className='text-danger'>Are you sure you want to delete this measure?</p>
                    </Modal.Body>
                    <Modal.Footer>
